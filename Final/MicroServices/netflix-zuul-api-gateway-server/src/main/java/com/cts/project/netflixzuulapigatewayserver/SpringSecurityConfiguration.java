	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable().authorizeRequests()
			...
			.antMatchers("/user-service/activate/**").permitAll()
				...
				.antMatchers("/user-service/admin-landing/**").access("hasRole('ADMIN')")
...
//				.antMatchers("/company-service/**").access("hasRole('ADMIN')")
//				.antMatchers("/stock-exchange-service/**").access("hasRole('ADMIN')")
//				.antMatchers("/initial-public-offering-service/**").access("hasRole('ADMIN')")
//				.antMatchers("/stock-price-service/**").access("hasRole('ADMIN')")
//				.antMatchers("/company-service/company/**").access("hasRole('USER')")
				.and().httpBasic();
	}
	@Override
