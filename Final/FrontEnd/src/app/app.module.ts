...
import { HttpInteceptorService } from './service/http-inteceptor.service';
import { UserLandingComponent } from './user/user-landing/user-landing.component';
import { ListIposComponent } from './user/list-ipos/list-ipos.component';
import { CompareReultsComponent } from './user/compare-reults/compare-reults.component';
